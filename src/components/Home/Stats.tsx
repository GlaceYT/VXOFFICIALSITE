    ...
    return(
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="text-center">
                <h4 className="text-xl font-medium text-gray-100">Numbers tell the hard works we’ve done in last 6 years</h4>
            </div>
    
            <div className="grid grid-cols-1 gap-6 px-6 mt-8 sm:px-0 lg:mt-16 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-12">
                <div className="overflow-hidden bg-gray-900 border border-gray-200 rounded-lg">
                    <div className="px-4 py-6">
                        <div className="flex items-start">
                            ...
                            <div className="ml-4">
                                <h4 className="text-4xl font-bold text-gray-100">6+</h4>
                ...
                <div className="overflow-hidden bg-gray-900 border border-gray-200 rounded-lg">
                    <div className="px-4 py-6">
                        <div className="flex items-start">
                            ...
                            <div className="ml-4">
                                <h4 className="text-4xl font-bold text-gray-100">37+</h4>
                ...
                <div className="overflow-hidden bg-gray-900 border border-gray-200 rounded-lg">
                    <div className="px-4 py-6">
                        <div className="flex items-start">
                            ...
                            <div className="ml-4">
                                <h4 className="text-4xl font-bold text-gray-100">3,274</h4>
                ...
                <div className="overflow-hidden bg-gray-900 border border-gray-200 rounded-lg">
                    <div className="px-4 py-6">
                        <div className="flex items-start">
                            ...
                            <div className="ml-4">
                                <h4 className="text-4xl font-bold text-gray-100">98%</h4>
