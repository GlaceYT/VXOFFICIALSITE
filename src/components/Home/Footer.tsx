    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 gap-x-5 gap-y-12 md:grid-cols-4 md:gap-x-12">
            ...
            <div>
                ...
                <ul className="mt-8 space-y-4">
                    <li>
                        <a href="https://www.binance.com/en-IN" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Binance </a>
                    </li>
                    <li>
                        <a href="https://www.xe.com/currencyconverter/" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Exchange Rates </a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul className="mt-8 space-y-4">
                    <li>
                        <a href="https://linktr.ee/validfw" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Valid FrameWork </a>
                    </li>
                    <li>
                        <a href="https://discord.gg/nuWzGbu8De" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Discord </a>
                    </li>
                </ul>
            </div>
        </div>
